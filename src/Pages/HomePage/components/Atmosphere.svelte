...
<section class="h-[200px] sm:h-[500px] lg:h-screen overflow-hidden relative">
	...
	>
	<button
		class="slider1-button-next absolute top-[50%] right-5 text-xl text-white z-20 bg-[#0000007e] p-[4px] rounded-full"
	...
	>
		...
		<SwiperSlide><img class="w-screen h-auto" src={sliderImg9} alt="" /></SwiperSlide>
		<SwiperSlide><img class="w-screen h-auto" src={sliderImg10} alt="" /></SwiperSlide>
		<SwiperSlide><img class="w-screen h-auto" src={sliderImg11} alt="" /></SwiperSlide>
	</Swiper>
</section>
