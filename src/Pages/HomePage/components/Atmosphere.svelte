<script lang="ts">
	...
	import sliderImg6 from '../../../assets/images/atmosphere/atmosphere11.jpg';
...
<section class="h-[230px] sm:h-[400px] lg:h-screen overflow-hidden relative">
	<button
		class="slider1-button-prev absolute top-[45%] left-5 text-xl text-white z-20 bg-[#0000007e] p-[4px] rounded-full"
	>
		<ChevronLeftIcon /></button
	>
	<button
		class="slider1-button-next absolute top-[45%] right-5 text-xl text-white z-20 bg-[#0000007e] p-[4px] rounded-full"
	...
	>
		...
		>
		<SwiperSlide
			><img class="w-full sm:w-screen h-[230px] sm:h-auto" src={sliderImg11} alt="" /></SwiperSlide
		>
	</Swiper>
</section>
